...
from torch_geometric.nn import GCNConv, SAGPooling, global_mean_pool, GraphNorm
from torch_geometric.nn.aggr import SoftmaxAggregation
import os
from torch_geometric.utils import sort_edge_index

class SAG_NO_POOL(nn.Module):
    def __init__(self):
        super(SAG_NO_POOL, self).__init__()
        in_features = int(os.getenv('EMBEDDING_DIM'))
        hidden_nodes = 256
        self.conv1 = GCNConv(in_features, hidden_nodes)
        self.norm1 = GraphNorm(hidden_nodes)
        ...
        self.norm2 = GraphNorm(hidden_nodes)
        ...
        self.norm3 = GraphNorm(hidden_nodes)
